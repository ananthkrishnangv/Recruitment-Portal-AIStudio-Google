            ...
            <div key={post.id} className="bg-white rounded-[2rem] border border-slate-200 hover:shadow-2xl transition-all duration-500 hover:-translate-y-1 group relative overflow-hidden flex flex-col md:flex-row p-2">
               ...
               <div className="p-8 md:p-10 flex-1">
                  <div className="flex flex-wrap items-center gap-3 mb-6">
                      <span className="px-3 py-1 bg-slate-900 text-white rounded-lg text-[10px] font-black uppercase tracking-[0.2em] shadow-sm font-mono">
                          {post.code}
                      </span>
                      <span className={`px-3 py-1 rounded-lg text-[10px] font-black uppercase tracking-[0.2em] border font-mono ${
